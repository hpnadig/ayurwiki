---
title: "Melicope lunu-ankenda - Matchbox tree, ಬೆಂಕಿಪೆಟ್ಟಿ ಗಿಡ, Kanali, Vanashampange, Kampili, Bok"
categories:
...
| Language | Names |
| --- | --- |
| English | Matchbox tree, Melicope |
| Kannada | ಬೆಂಕಿಪೆಟ್ಟಿ ಗಿಡ Benkipettige gida, ಮುಗಳಿ Mugali |
| Malayalam | Kampili |
| Marathi | Bok |
| Tamil | Kanali, Kattucampakam |
| Telugu | Vanashampange |
...
1. ["Chemistry"]
2. ["Morphology"]
3. [names](Common)(https://sites.google.com/site/indiannamesofplants/via-species/m/melicope-lunu-ankenda)
4. [ "Cultivation"]
