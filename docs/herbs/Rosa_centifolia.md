...
categories:
  ...
  - "Herbs"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Air_layering"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Cuttings_of_half-ripe_wood"
  - "Index_of_Plants_which_can_be_propagated_by_Seeds"
  - "Herbs_with_Seeds_used_in_medicine"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Cuttings_of_mature_wood"
  - "Index_of_Plants_which_can_be_propagated_by"
  - "Habit_-_Deciduous_shrub"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Division_of_suckers"
...
![](../images/Rosa_centifolia_003.JPG)
**Rosa centifolia** is a deciduous shrub that can grow up to 1.50 metres tall. It is harvested from the wild for local use as a food, medicine and source of materials.
## Uses
Constipation, Cancer.
...
![](../images/Rosa_centifolia_002.JPG)
![](../images/Rosa_centifolia_003.JPG)
![](../images/Rosa_centifolia_2019-06-04_5447.jpg)

## References

## External Links
* [Rosa centifolia on pfaf.org](https://pfaf.org/user/Plant.aspx?LatinName=Rosa+centifolia)

## References

1. [constituents](Chemical)(https://www.actahort.org/books/766/766_65.htm)
2. [Morphology]
