---
title: "Lantana camara - Lantana, Kaadujola, Raimuniya, Unnichedi, Pulikampa, Tantani"
categories:
  ...
  - "Ayurvedic_Herbs_known_to_be_helpful_to_treat_Skin_itches"
  ...
  - "Herbs_that_are_commonly_seen_in_the_region_of_Moist_habitats"
  - "Ayurvedic_Herbs_known_to_be_helpful_to_treat_Toothache"
  - "Ayurvedic_Herbs_known_to_be_helpful_to_treat_Leprosy"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Plantation_crops"
...
date: 2021-11-11
---
# Lantana camara - Lantana, Kaadujola, Raimuniya, Unnichedi, Pulikampa, Tantani
...
## Photo Gallery
![](../images/Lantana_camara_2.jpg)
![](../images/Lantana_camara_3.jpg)
![](../images/Lantana_camara_4.jpg)
![](../images/Lantana_camara_5.jpg)
![](../images/Antillean_crested_hummingbird_feeding.jpg)

## References

## External Links
* [Lantana camara on lucidcentral.org](https://keys.lucidcentral.org/keys/v3/eafrinet/weeds/key/weeds/Media/Html/Lantana_camara_(Lantana).htm)
* [Lantana camara on lucidcentral.org](https://keyserver.lucidcentral.org/weeds/data/media/Html/lantana_camara.htm)
* [Lantana camara on plants.ifas.ufl.edu](http://plants.ifas.ufl.edu/plant-directory/lantana-camara/)

## References

1. [constituents](Chemical)(https://www.imedpub.com/articles/chemical-constituents-and-toxicity-assessment-of-the-leaf-oil-oflantana-camara-linn-from-tamilnadu-regions.pdf)
2. [Morphology]
...
7. **Daitota, P. S. Venkatarama. *Auṣadhīya Sasyagaḷu (ಔಷಧೀಯ ಸಸ್ಯಗಳು; Medicinal Plants)*. Vivekananda Samshodhana Kendra, Vivekananda Vidyavardhaka Sangha, Puttur, 2016, pp. 141-142.**
   Medicinal uses as mentioned in Daitota's Auṣadhīya Sasyagaḷu: presented as a remedy for burn wounds (beṅkiyalli guṇa-disuva). Despite being an invasive ornamental, the author records its strong burn-healing action when applied as a leaf-and-coconut-oil paste. NOTE (added editorially): the unripe black-coloured fruit of Lantana camara is toxic to children — the book does not mention this.
