---
title: "Helicteres isora - Indian screw tree, ಭೂತಕರುಳು, Marodphali, Edampuri, Aadasamanthi, Ishvaramuli"
categories:
...
date: 2022-08-23
---
# Helicteres isora - Indian screw tree, ಭೂತಕರುಳು, Marodphali, Edampuri, Aadasamanthi, Ishvaramuli

[TOC]

![*Avartani*, *Helicteres isora*](../images/Helicteres_isora_(East_Indian_screw_tree)_W2_IMG_1250.jpg)
...
## Uses
Diarrhea, Dysentery, Intestinal parasites, Scabies, Biliousness.

## Parts Used
Bark, Root, Leaf.

## Chemical Composition
It contains three new compounds Glucopyranosyl rosmarinic acid and Lactic acid named as 4'-O-β-D-glucopyranosyl isorinic acid etc.
...
Helicteres isora is easily propagated by seed, but vegetative propagation with stem cuttings is also possible.

## Commonly seen growing in areas
Tropical area

## Photo Gallery
![Young leaves](../images/East_Indian_screw_tree_(Helicteres_isora)_foliage_at_Kambalakonda_09.JPG)
![Flower](../images/Helicteres_isora_30.JPG)
![Roots](../images/Helictrus_isora_05.JPG)
![](../images/(Helicteres_isora)_East_Indian_screw_tree_seed_at_Kambalakonda_07.JPG)
![Matured leaves](../images/Helicteres_isora_(East_Indian_screw_tree)_W_IMG_1245.jpg)

## References

## External Links
* [Helicteres isora on ncbi.govt](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4025269/)
* [Helicteres isora on helicteres isro.com](https://www.google.com/search?q=helicteres+isora+uses&oq=helicteres+isora+uses&aqs=chrome..69i57.9362j0j7&sourceid=chrome&ie=UTF-8)

## References

1. [Uses](https://easyayurveda.com/2015/06/03/helicteres-isora-avartani-uses-dose-research-side-effects/)
