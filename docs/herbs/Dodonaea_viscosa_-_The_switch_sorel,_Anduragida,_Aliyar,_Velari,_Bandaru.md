---
title: "Dodonaea viscosa - The switch sorel, Anduragida, Aliyar, Velari, Bandaru"
categories:
  - "Herbs_with_common_name_in_Hindi"
  - "Herbs_that_are_commonly_seen_in_the_region_of_Dry_slopes"
  ...
  - "Herbs_that_are_commonly_seen_in_the_region_of_Sandy_soils"
  ...
  - "Herbs_that_are_commonly_seen_in_the_region_of_Stony_soils"
...
date: 2020-08-06
---
# Dodonaea viscosa - The switch sorel, Anduragida, Aliyar, Velari, Bandaru
...
It contains  β-carotene-linoleic acid; DPPH(•), ABTS(•+), superoxide scavenging, CUPRAC and metal chelating assays. Anticholinesterase activity was performed using the Elman method. Results Clerodane diterpenoids (1 and 2) and phenolics.
...
A plant of the warm temperate to tropical zones, where it is found at elevations up to 1,600 metres. It grows best in areas where annual daytime temperatures are within the range 18 - 38°c, but can tolerate 7 - 45°c.
...
## Photo Gallery
![](../images/Dodonaea_viscosa_(Hopbush)_W_IMG_1898.jpg)
![](../images/Dodonaea_viscosa_(Hopbush)_W2_IMG_1899.jpg)
![](../images/Dodonaea_viscosa_2xwinged_fruit.JPG)

## References

## External Links
* [Dodonaea viscosa on flowersofindia.net](http://www.flowersofindia.net/catalog/slides/Hop%20Bush.html)
* [Dodonaea viscosa on pfaf.org](https://pfaf.org/user/Plant.aspx?LatinName=Dodonaea+viscosa)
* [Dodonaea viscosa on Lucidcentral.org](https://keys.lucidcentral.org/keys/v3/eafrinet/weeds/key/weeds/Media/Html/Dodonaea_viscosa_(Sand_Olive).htm)
