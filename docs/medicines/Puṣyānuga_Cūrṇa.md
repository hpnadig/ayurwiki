---
title: "Puṣyānuga Cūrṇa"
categories:
  - "Therapeutic_use_of_Formula_-_Menorrhagia"
  - "Therapeutic_use_of_Formula_-_Disorders_of_female_genital_tract"
  - "Therapeutic_use_of_Formula_-_Menstrual_disorder"
  - "Ayurvedic Medicine"
  ...
  - "Therapeutic use of Formula - Menstrual disorder"
  - "Therapeutic_use_of_Formula_-_Leucorrhoea"
  - "Therapeutic_use_of_Formula_-_Piles"
  - "Ayurvedic_Medicine"
  - "Therapeutic use of Formula - Menorrhagia"
date: 2018-09-14
---
# Puṣyānuga Cūrṇa
...
| Pāṭhā API | [Cissampelos pareira](Cissampelos_pareira.md) | Rt. | 1 part |
| --- | --- | --- | --- |
...
| Bilva API | [Aegle marmelos](Aegle_marmelos.md) | Rt./St.Bk. | 1 part |
| Lodhra API | [Symplocos racemosa](Symplocos_racemosa.md) | St.Bk. | 1 part |
...
| Vatsaka (Kuṭaja API) | [Holarrhena](Holarrhena.md) | St. Bk. | 1 partantidysenterica |
| Anantā (Śveta sārivā API) | [Hemidesmus indicus](Hemidesmus_indicus.md) | Rt | 1 part |
| Dhātakī API | [Woodfordia fruticosa](Woodfordia_fruticosa.md) | Fl. | 1 part |
| Madhuka (Yaṣṭī API) | [Glycyrrhiza glabra](Glycyrrhiza_glabra.md) | Rt. | 1 part |
| Arjuna API | [Terminalia arjuna](Terminalia_arjuna.md) | St. Bk. | 1 part |
...
* Pass through sieve number 44 to prepare a homogeneous blend.
...
## Anupāna
* Milk or [Tandulodaka](Tandulodaka.md).
