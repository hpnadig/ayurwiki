---
title: "Triphalā Ghṛta"
categories:
  - "Therapeutic_use_of_Formula_-_Lacrimation"
  - "Therapeutic use of Formula - Cough"
  - "Therapeutic_use_of_Formula_-_Falling_of_hair"
  - "Therapeutic_use_of_Formula_-_Intermittent_fever"
  - "Therapeutic_use_of_Formula_-_Itching"
  - "Ayurvedic Medicine"
  - "Therapeutic use of Formula - Lacrimation"
  - "Therapeutic use of Formula - Pain in eyes"
  - "Therapeutic_use_of_Formula_-_Tumours"
  - "Therapeutic_use_of_Formula_-_Excessive_vaginal_discharge"
  - "Therapeutic use of Formula - Disorders of eyelids"
  - "Therapeutic_use_of_Formula_-_Disorders_of_Blood"
  - "Therapeutic_use_of_Formula_-_Oedema"
  - "Therapeutic use of Formula - Cataract"
  - "Therapeutic use of Formula - Pterygium"
  - "Therapeutic use of Formula - Oedema"
  - "Therapeutic use of Formula - Disorders of Blood"
  - "Therapeutic_use_of_Formula_-_Alopecia"
  - "Therapeutic_use_of_Formula_-_Pain_in_eyes"
  - "Therapeutic use of Formula - Excessive vaginal discharge"
  - "Formulations"
  - "Therapeutic_use_of_Formula_-_Eye_disorders_to_sclera"
  - "Therapeutic_use_of_Formula_-_Pterygium"
  - "Therapeutic use of Formula - Eye disorders to sclera"
  - "Therapeutic use of Formula - Falling of hair"
  - "Therapeutic_use_of_Formula_-_Cough"
  - "Therapeutic_use_of_Formula_-_Erysepelas"
  - "Therapeutic use of Formula - Intermittent fever"
  - "Therapeutic use of Formula - Erysepelas"
  - "Therapeutic use of Formula - Tumours"
  - "Therapeutic use of Formula - Jaundice"
  - "Therapeutic use of Formula - Itching"
  - "Therapeutic_use_of_Formula_-_Cataract"
  - "Therapeutic_use_of_Formula_-_Disorders_of_eyelids"
  - "Therapeutic use of Formula - Alopecia"
  - "Ayurvedic_Medicine"
...
**Triphalā Ghrta** is a medicated preparation made with the ingredients in the Formulation composition given below with Gh¨ta as the basic ingredient.
...
* Pulverize ingredient 22 (consisting of Triphalā ingredients) to a coarse powder, add 8 parts of water, heat and reduce the volume to one fourth. Filter with muslin cloth to obtain Triphalā kvātha
