...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Hemorrhoids"
  ...
  - "Therapeutic use of Formula - Hemorrhoids"
...
| Vyosha |  |  |  |
| a. áu¸¶h¢ API | [Zingiber officinale](Zingiber_officinale_-_Ginger.md) | Rz. | 48 g |
| b. Marica API | Piper nigrum | Fr. | 48 g |
| c. Pippalī API | Piper longum | Fr. | 48 g |
| Vi·a´ga API | [Embelia ribes](Embelia_Ribes_-_Vidanga.md) | Fr. | 48 g |
| D¡ru (Devad¡ru API) | Cedrus deodara | Ht. Wd. | 48 g |
| Citraka API | [Plumbago zeylanica](Plumbago_Zeylanica_-_Chitraka.md) | Rt. | 48 g |
| KuÀ¶ha API | Saussurea lappa | Rt. | 48 g |
| Haridr¡dvaya |  |  |  |
...
| Dant¢ API | Baliospermum montanum | Rt. | 48 g |
| Cavya API | Piper chaba | St. | 48 g |
| Kali´gaka (Indrayava API) | Holarrhena antidysenterica | Sd. | 48 g |
| Pippal¢ API | Piper longum | Fr. | 48 g |
| Pippal¢m£la (Pippal¢ API) | Piper longum | St. | 48 g |
| Musta (Must¡ API) | Cyperus rotundus | Rz. | 48 g |
| Ma¸·£ra (Ma¸·£ra Bhasma (API)) | Calcined Ma¸·£ra |  | 1.920 kg |
| Gom£tra (API) | Cow urine |  | 6.144 l |
...
* Strain [Gomutra](Gomutra.md) through muslin cloth.
...
## Therapeutic uses
* Pandu Roga (Anaemia), Grahani (Malabsorption syndrome), shotha (Inflammation), Pliha Roga (Splenic disease), Vishamajvara (Intermittent fever), Arsa (Hemorrhoids), Kustha (Diseases of skin), Krmi (Helminthiasis/Worm infestation).
...
| --- | --- |
| Acid-insoluble ash | Not more than 28 per cent |
| Methanol-soluble extractive | 15 to17 per cent |
| Water-soluble extractive | 24 to 26 per cent |
| Loss on drying | Not more than 8 per cent |
| pH (1 % aqueous solution) | 6 to 7 |
