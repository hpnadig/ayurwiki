---
title: "Vyoṣādi Guggulu"
categories:
  - "Ayurvedic Medicine"
  - "Therapeutic use of Formula - Rheumatism"
  - "Therapeutic_use_of_Formula_-_Obesity"
  - "Formulations"
  - "Therapeutic use of Formula - Obesity"
  - "Therapeutic_use_of_Formula_-_Rheumatism"
  - "Therapeutic_use_of_Formula_-_Diseases_due_to_Kapha_Dosha"
  - "Ayurvedic_Medicine"
...
| 4. Citraka API | [Plumbago zeylanica](Plumbago_zeylanica.md) | Rt. | 1 Part |
| 5. Mustā API | [Cyperus rotundus](Cyperus_rotundus.md) | Rz. | 1 Part |
| 6. Harītakī API | [Terminalia chebula](Terminalia_chebula.md) | P. | 1 Part |
| 7. Bibhītaka API | [Terminalia belerica](Terminalia_belerica.md) | P. | 1 Part |
| 8. Āmalakī API | [Emblica officinalis](Emblica_officinalis.md) | P. | 1 Part |
| 9. Viḍaṅga API | [Embelia ribes](Embelia_ribes.md) | Fr. | 1 Part |
| 10. [Guggulu](../medicines/Guggulu.md)- API Śuddha | Commiphora wightii | O.R. | 9 Parts |
