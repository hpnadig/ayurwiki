...
categories:
  ...
  - "Ayurvedic Medicine"
  - "Therapeutic_use_of_Formula_-_Cysts"
  - "Therapeutic_use_of_Formula_-_Tumor"
  - "Therapeutic use of Formula - Skin diseases"
  - "Therapeutic_use_of_Formula_-_Asthma"
  - "Therapeutic_use_of_Formula_-_Heart_diseases"
  - "Therapeutic use of Formula - Cysts"
...
**Khadirāriṣṭa** is a fermented liquid preparation made with the ingredients in the Formulation composition given below. It contains not more than 10 per cent, and not less than 5 per cent of alcohol that is self generated in the preparation over a period of time.

## Formulation composition
| Khadira API | [Acacia catechu](../medicines/Acacia_catechu.md) | Ht. Wd | 2.4 kg |
| --- | --- | --- | --- |
...
| Prakṣepa Dravyas: |  |  |  |
| Dhātakī API | [Woodfordia fruticosa](Woodfordia_fruticosa.md) | Fl. | 960 g |
...
| Lavaṅga API | [Syzygium aromaticum](Syzygium_aromaticum.md) | Fl. Bd. | 48 g |
...
| Patra (Tejapatra API) | [Cinnamomum tamala](Cinnamomum_tamala.md) | Lf. | 48 g |
| Kṛṣṇā (Pippalī API) | [Piper longum](Piper_longum.md) | Fr. | 192 g |
...
* Add specified amounts of water to the Kvatha Dravya, soak overnight, heat, reduce to one eighth and filter through muslin cloth to obtain Kvatha.
