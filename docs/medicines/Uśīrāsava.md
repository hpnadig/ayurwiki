...
categories:
  ...
  - "Therapeutic use of Formula - Inflammatory diseases"
...
**Uśīrāsava** is a fermented liquid preparation, made with the ingredients in the Formulation composition given below. It contains not more than 10 per cent, and not less than 5 per cent of alcohol that is self generated in the preparation over a period of time.
...
| Pāthā API | [Cissampelos pareira](Cissampelos_pareira.md) | Rt. /Pl. | 48 g |
| Kirātatikta API | [Swertia chirata](Swertia_chirata.md) | Pl. | 48 g |
...
| Drākṣa API | [Vitis vinifera](Vitis_vinifera.md) | Dr. Fr. | 960 g |
| Dhātakī API | [Woodfordia fruticosa](Woodfordia_fruticosa.md) | Fl. q.s. | for dh£pana |
| Jala Water |  |  | 24.576 l |
| Śarkarā API | Sugar |  | 768 g |
| Kṣaudra (Madhu) API | Honey |  | 4.8 kg |
| Marica API | [Piper nigrum](Piper_nigrum.md) | Fr. q.s. | for dh£pana |
...
* Transfer the filtrate to a clean container; add Madhu, Draksha, Dhataki and coarsely powdered other drugs. Seal the mouth of the container.
...
## Therapeutic uses
* Raktapitta (Bleeding disorders), Pāṇḍu (Aneamia), Kuṣṭha (Skin diseases), Prameha (Urinary disorders), Arṣa (Piles), Kṛmi (Worm infestation), Śotha (Inflammatory diseases).
