...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Dysmenorrhoea"
  ...
  - "Therapeutic_use_of_Formula_-_Leucorrhoea"
  - "Therapeutic_use_of_Formula_-_Polyuria"
  - "Ayurvedic_Medicine"
date: 2023-06-22
---
# Aśokāriṣṭa
...
| Aśokā API | [Saraca asoca](Saraca_asoca.md) | St. Bk. | 4.800 kg |
| --- | --- | --- | --- |
| Jala for decoction | Water |  | 49.152 l |
| reduced to |  |  | 12.288 l |
| Guḍa API | Jaggery |  | 9.6 kg |
| [Prakṣepa Dravya](Prakṣepa_Dravya.md): |  |  |  |
...
| Āmalakī API | [Emblica officinalis](Emblica_officinalis.md) | P. | 48 g |
| Āmrāsthi (Āmra API) | [Mangifera Indica](Mangifera_Indica.md) | Enm. | 48 g |
| Jīraka (Śveta Jīraka API) | [Cuminum cyminum](Cuminum_cyminum.md) | Fr. | 48 g |
| Vāsā API | [Adhatoda vasica](Adhatoda_vasica.md) | Rt. | 48 g |
| Candana (Śveta Candana API) | [Santalum album](Santalum_album.md) | Ht. Wd. | 48 g |

## Method of preparation
* Take the raw materials of pharmacopoeial quality.
* Wash, dry and powder the ingredient numbered 1 ([Kvātha Dravya](Kvātha_Dravya.md)) of the formulation composition and pass through the sieve number 44 to obtain coarse powder.
* Clean, dry and powder the ingredients numbered 5 to 16 ([Prakṣepa Dravya](Prakṣepa_Dravya.md)) of the formulation composition individually and pass through the sieve number 85 to obtain fine powder.
