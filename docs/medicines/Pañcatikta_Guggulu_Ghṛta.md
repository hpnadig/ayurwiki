---
title: "Pañcatikta Guggulu Ghṛta"
categories:
  - "Therapeutic use of Formula - Cough"
  - "Therapeutic_use_of_Formula_-_Sinus"
  - "Ayurvedic Medicine"
  - "Therapeutic use of Formula - Sinusitis"
  - "Therapeutic use of Formula - Sinus"
  - "Therapeutic_use_of_Formula_-_Tumour"
  - "Therapeutic_use_of_Formula_-_Excessive_flow_of_urine"
  - "Therapeutic use of Formula - Chronic rhinitis"
  - "Therapeutic_use_of_Formula_-_Intoxication"
  ...
  - "Therapeutic_use_of_Formula_-_Tuberculosis"
  - "Therapeutic use of Formula - Vata confined to bones"
  - "Therapeutic_use_of_Formula_-_Asthma"
  - "Therapeutic_use_of_Formula_-_Vata_confined_to_bones"
  - "Therapeutic_use_of_Formula_-_Cervical_lymphadenitis"
  - "Therapeutic_use_of_Formula_-_Heart_disease"
  - "Therapeutic_use_of_Formula_-_Oedema"
  - "Therapeutic use of Formula - Anorectal disease"
  - "Therapeutic use of Formula - Heart disease"
  - "Therapeutic_use_of_Formula_-_Bone_marrow_related_disorders"
  - "Therapeutic use of Formula - Bone marrow related disorders"
  - "Therapeutic use of Formula - Fistula-in-ano"
  - "Therapeutic use of Formula - Osteoarthropathy"
  - "Therapeutic use of Formula - Disease of head and neck"
  ...
  - "Therapeutic_use_of_Formula_-_Chronic_rhinitis"
  - "Therapeutic_use_of_Formula_-_Anorectal_disease"
  - "Therapeutic_use_of_Formula_-_Sinusitis"
  - "Therapeutic_use_of_Formula_-_Disease_of_head_and_neck"
  - "Therapeutic use of Formula - Intoxication"
  - "Formulations"
  - "Therapeutic use of Formula - Abscess"
  - "Therapeutic_use_of_Formula_-_Disease_of_skin"
  ...
  - "Therapeutic use of Formula - Goitre"
  - "Therapeutic_use_of_Formula_-_Tastelessness"
  - "Therapeutic_use_of_Formula_-_Anaemia"
  - "Therapeutic use of Formula - Tastelessness"
  - "Therapeutic_use_of_Formula_-_Abscess"
  - "Therapeutic use of Formula - Tumour"
  - "Ayurvedic_Medicine"
  - "Therapeutic_use_of_Formula_-_Goitre"
  - "Therapeutic_use_of_Formula_-_Osteoarthropathy"
date: 2023-06-29
---
...
**Pañcatikta Guggulu Ghṛta** is semisolid preparation made with the ingredients given in the Formulation Composition given below

## Formulation composition
| Nimbatvak (Nimba API) | [Azadirachta indica](Azadirachta_indica.md) | St. Bk. | 480 g |
| --- | --- | --- | --- |
...
| Tejovatī API | [Zanthoxylum alatum](Zanthoxylum_alatum.md) | Fr. | 12 g |
| Marica API | [Piper nigrum](Piper_nigrum.md) | Fr. | 12 g |
| Vatsaka (Kuṭaja API) | [Holarrhena antidysenterica](Holarrhena_antidysenterica.md) | St. Bk. | 12 g |
| Dīpyaka (Yavānī API) | [Trachyspermum ammi](Trachyspermum_ammi.md) | Fr. | 12 g |
| Agni (Citraka API) | [Plumbago zeylanica](Plumbago_zeylanica.md) | Rt | 12 g |
| Rohiṇī (Kaṭukā API) | [Picrorrhiza kurrooa](Picrorrhiza_kurrooa.md) | Rz./Rt. | 12 g |
| Aruṣkara (Bhallātaka-Śuddha API) | [Semecarpus anacardium](Semecarpus_anacardium.md) | Fr. | 12 g |
| Vacā API | [Acorus calamus](Acorus_calamus.md) | Rz. | 12 g |
| Kaṇāmūla (Pippalī API) | [Piper longum](Piper_longum.md) | Rt. | 12 g |
| Yuktā (Rāsnā API) | [Pluchea lanceolata](../herbs/Pluchea_lanceolata.md) | Rt./Lf.* | 12 g |
| Mañjiṣṭhā API | [Rubia cordifolia](Rubia_cordifolia.md) | Rt. | 12 g |
| Ativiṣā API | [Aconitum heterophyllum](Aconitum_heterophyllum.md) | Rt. Tr | 12 g |
| Vāṣā (Ativiṣā Bheda API) | [Aconitum palmatum](../herbs/Aconitum_palmatum.md) | Rt. | 12 g |
| Yavānī API | [Trachyspermum ammi](Trachyspermum_ammi.md) | Fr. | 12 g |
| Guggulu (Śuddha API) | [Commiphora wighti](Commiphora_wighti.md) | O.R. | 240 g |
...
## Therapeutic uses
* Sandhigata vāta (Osteoarthropathy), Asthigata vāta (Vata confined to bones), Majjāgata vāta (Bone marrow related disorders), Nāḍī vraṇa (Sinus), Kuṣṭha (Disease of skin), Arbuda (Tumour), Bhagandara (Fistula in ano), Gaṇdamālā (Goiter/Cervical lymphadenitis), Guda Roga (Anorectal disease), Meha (Excessive flow of urine), Yakṣma (Tuberculosis), Aruci (Tastelessness), svāsa (Asthma), Pīnasa (Chronic rhinitis/Sinusitis), Kāsa (Cough), Śopha (Oedema), Hṛdroga (Heart disease), Pāṇḍu (Anaemia), Mada (Intoxication), Vidradhi (Abscess), Vātarakta (Gout), Ūrdhvajatrugata Roga (Disease of head and neck).
...
1. THE AYURVEDIC PHARMACOPOEIA OF INDIA, PART-II, VOLUME-II, page no 171.
