---
title: "Yogarāja Guggulu"
categories:
  - "Therapeutic use of Formula - Splenomegaly"
  ...
  - "Therapeutic_use_of_Formula_-_Bone_marrow_disorders"
  - "Therapeutic use of Formula - Distension of abdomen"
  - "Therapeutic_use_of_Formula_-_Rheumatism"
  - "Therapeutic use of Formula - Osteoarthropathy"
  - "Therapeutic_use_of_Formula_-_Gout"
  - "Therapeutic_use_of_Formula_-_Distension_of_abdomen"
  - "Therapeutic_use_of_Formula_-_Splenomegaly"
  - "Therapeutic_use_of_Formula_-_Non-healing_ulcer"
  ...
  - "Therapeutic_use_of_Formula_-_Worm_infestation"
  - "Formulations"
  ...
  - "Therapeutic use of Formula - Bone marrow disorders"
...
**Yogarāja Guggulu** Vati is preparation made with the ingredients in the Formulation Composition, given below, with [Guggulu](../medicines/Guggulu.md) as the basic ingredient.

## Formulation composition
| Citraka API | [Plumbago zeylanica](Plumbago_zeylanica.md) | Rt. | 1 part |
| --- | --- | --- | --- |
| Pippalīmūla API | [Piper longum](Piper_longum.md) | Rt. | 1 part |
| Yamānī (Yavānī API) | [Trachyspermum ammi](Trachyspermum_ammi.md) | Sd. | 1 part |
| Kāravī (Kṛṣṇa Jīraka API) | [Carum carvi](Carum_carvi.md) | Fr. | 1 part |
| Viḍaṅga API | [Embelia ribes](Embelia_ribes.md) | Fr. | 1 part |
...
| Rāsnā API | [Pluchea lanceolata](../herbs/Pluchea_lanceolata.md) | Rt./ Lf.* | 1 part |
| Gokṣura API | [Tribulus terrestris](Tribulus_terrestris.md) | Fr. | 1 part |
| Dhānyaka API | [Coriandrum sativum](Coriandrum_sativum.md) | Fr. | 1 part |
...
| Uśīra API | [Vetiveria zizanoides](Vetiveria_zizanoides.md) | Rt. | 1 part |
| Yavāgraja (Yava) Kṣāra API | Hordeum vulgare | Water soluble ash of Pl. | 1 part |
| Tālīsa Patra API | [Taxus wallichi](Taxus_wallichi.md) | Lf. | 1 part |
| Patra (Tejapatra API) | [Cinnamomum tamala](Cinnamomum_tamala.md) | Lf. | 1 part |
| Guggulu API -Śuddha | Commiphora wightii | O.R. | 27 parts |
| Sarpi (Goghṛta API) | Clarified butter From Cow's milk |  | 1 part |
...
* Roll the Vatis on flat surface to round them by circular motion of palm covered with a glove and smeared with Eraṇḍa Taila or use suitable mechanical device.

## Description
* Dark brown spherical Vati with spicy pleasant odour and astringent taste.

## Storage
* Store in a cool place in tightly closed containers, protect from light and moisture.

## Therapeutic uses
* Udararoga (Diseases of abdomen), Āmavāta (Rheumatism), Āḍhyavāta (Gout), Kṛmi (Worm infestation), Duṣṭavṛna (Non-healing ulcer), Plīhāvṛddhi (Splenomegaly), Gulma (Abdominal lump), Ānāha (Distension of abdomen), Arśa (Piles), Agnimāndya (Digestive impairment), Daurbalya (Weakness), Sandhigata Vata (Osteoarthropathy), Majjāgata vāta (Bone marrow disorders).
