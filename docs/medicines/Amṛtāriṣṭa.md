...
**Amṛtāriṣṭa** is a fermented liquid preparation made with the ingredients in the Formulation composition given below. It contains not more than 10 per cent, and not less than 5 per cent of alcohol that is self generated in the preparation over a period of time.

## Formulation composition
| Amṛtā (Guḍūcī API) | [Tinospora cordifolia](Tinospora_cordifolia.md) | St. | 4.8 kg |
| --- | --- | --- | --- |
| Bilva API | [Aegle marmelos](Aegle_marmelos.md) | St. Bk. | 480 g |
| Śyonāka API | [Oroxylum indicum](Oroxylum_indicum.md) | St. Bk. | 480 g |
| Gambhārī API | [Gmelina arborea](Gmelina_arborea.md) | St. Bk. | 480 g |
...
| Abda (Mustā API) | [Cyperus rotundus](Cyperus_rotundus.md) | Rz. | 48 g |
| Kaṭvī (Kaṭukā API) | [Picrorrhriza kurroa](Picrorrhriza_kurroa.md) | Rz. | 48 g |
| Prativiṣā (Ativiṣā) API) | [Aconitum heterophyllum](Aconitum_heterophyllum.md) | Rt. | 48 g |
| Vatsabīja (Indrayava API) | [Holarrhena antidysenterica](Holarrhena_antidysenterica.md) | Sd. | 48 g |

## Method of preparation
* Take the raw material of pharmacopoeial quality.
* Wash, dry and powder the ingredients numbered 1 to 11 ([Kvātha Dravya](Kvātha_Dravya.md)) of the formulation composition individually and pass through the sieve number 44 to obtain coarse powder.
* Clean, dry and powder the ingredients numbered 14 to 24 ([Prakṣepa Dravya](Prakṣepa_Dravya.md)) of the formulation composition individually and pass through the sieve number 85 to obtain fine powder.
* Add specified amounts of water to the [Kvātha Dravya](Kvātha_Dravya.md), soak overnight, heat, reduce to one fourth and filter through muslin cloth to obtain [Kvātha](../Kvātha.md).
