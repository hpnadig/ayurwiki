...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Gastro-enteritis_with_piercing_pain"
  - "Ayurvedic_Medicine"
...
| Mustakā (Mustā API) | [Cyperus rotundus](Cyperus_rotundus.md) | Rz. | 2.4 kg |
| --- | --- | --- | --- |
...
| Vahni (Citraka API) | [Plumbago zeylanica](Plumbago_zeylanica.md) | Rt. | 24 g |
...
* Add specified amount of water to the Kv¡tha Dravya, soak overnight, heat, reduce to one fourth and filter through muslin cloth to obtain Kv¡tha.
