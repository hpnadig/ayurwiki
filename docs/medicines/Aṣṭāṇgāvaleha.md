...
categories:
  ...
  - "Ayurvedic Medicine"
  - "Therapeutic use of Formula - Fever due to vaāta dosha and kapha dosha"
  - "Ayurvedic_Medicine"
  - "Therapeutic_use_of_Formula_-_Emesis"
  - "Formulations"
  - "Therapeutic use of Formula - Tastelessness"
  - "Therapeutic_use_of_Formula_-_Cough"
  - "Therapeutic_use_of_Formula_-_Fever_due_to_vaāta_dosha_and_kapha_dosha"
...
**Aṣṭāṇgāvaleha** is a semisolid avaleha preparation made with the ingredients in the Formulation composition given below.

## Formulation composition
| Katphala API | [Myrica nagi](Myrica_nagi.md) | St Bk. | 1 part |
| --- | --- | --- | --- |
| Pauskara (Puskara API) | [Inula racemosa](Inula_racemosa.md) | Rt. | 1 part |
...
* Wash and peel [Ārdraka](Ārdraka.md), grind it, squeeze the juice and filter it through a muslin cloth to collect [svarasa](svarasa.md).
* Mix the powdered ingredients 1 to 8 thoroughly, levigate with Ārdraka svarasa and later dry the mixture.
* Add honey and stir thoroughly to form an [avaleha](avaleha.md).
