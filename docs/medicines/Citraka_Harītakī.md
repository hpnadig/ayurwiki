...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Helminthiasis"
  - "Therapeutic use of Formula - Dyspnoea"
  - "Therapeutic use of Formula - Pthisis"
  - "Therapeutic_use_of_Formula_-_Upward_movement_of_gases"
  ...
  - "Therapeutic use of Formula - Helminthiasis"
...
| Citraka API – kvātha | [Plumbago zeylanica](Plumbago_zeylanica.md) | Rt. | 4.800 l |
| --- | --- | --- | --- |
| Āmalakī API - kvātha | [Phyllanthus emblica](Phyllanthus_emblica.md)(Emblica officinalis) | P. | 4.800 l |
| Gudūcī API – kvātha | [Tinospora cordifolia](Tinospora_cordifolia.md) | St. | 4.800 l |
| Daśāmūla API - kvātha |  |  | 4.800 l |
| (a.) Bilva API | [Aegle marmelos](Aegle_marmelos.md) | Rt./St. Bk. |  |
| (b.) Agnimantha API | [Premna mucronata](Premna_mucronata.md) | Rt./St. Bk. |  |
| (c.) Śyonāka API | [Oroxylum indicum](Oroxylum_indicum.md) | Rt./St. Bk. |  |
...
| Elā (Sūkşmailā API) | [Elettaria cardamomum](Elettaria_cardamomum.md) | Sd. | 96 g |
| Patra (Tejapatra API) | [Cinnamomum tamala](Cinnamomum_tamala.md) | Lf. | 96 g |
| Madhu API | Honey |  | 384 g |
| Kṣāra (Yava API) | [Hordeum vulgare](Hordeum_vulgare.md) | Water soluble Ash of Pl. | 24 g |

## Method of preparation
* Wash, dry and powder the ingredients numbered 1 to 4 ([Kvātha dravya](Kvātha_dravya.md)) of the Formulation composition separately and pass through sieve no. 44 to obtain a coarse powder.
* Dry and powder the ingredient number 5 separately and ingredients number 7 to 13 ([Praksepa dravya](Praksepa_dravya.md)s) of the Formulation composition to a fine powder and pass through sieve no. 85.
...
* Reduce the [Kvātha](../Kvātha.md) to a thicker consistency by gentle boiling; add cūrņa of Pathyā and stir thoroughly during the process.
* Add the powdered praksepa dravya no. 7 to 13 while hot at 500 ,mix thoroughly to prepare a homogeneous mass.
...
## Therapeutic uses
* Gulma (Abdominal lump), Udāvarta (Upward movement of gases), Pīnasa (Chronic rhinitis/Sinusitis), Kāsa (Cough), Svāsa (Dyspnoea), Arśa (Piles), Agnimāndya (Loss of appetite), Kṣaya (Pthisis), Kṝmi (Helminthiasis / Worm infestation).
