...
categories:
  ...
  - "Therapeutic use of Formula - Inability to speak properly"
  - "Therapeutic_use_of_Formula_-_Mental_retardation"
  - "Therapeutic_use_of_Formula_-_Skin_disorders"
  - "Therapeutic use of Formula - Memory loss"
  - "Ayurvedic Medicine"
  - "Formulations"
  - "Therapeutic use of Formula - Skin disorders"
  - "Therapeutic_use_of_Formula_-_Insanity"
  - "Therapeutic_use_of_Formula_-_Epilepsy"
  - "Therapeutic use of Formula - Insanity"
  - "Therapeutic_use_of_Formula_-_Infertility"
  - "Therapeutic use of Formula - Mental retardation"
  - "Therapeutic_use_of_Formula_-_Memory_loss"
  - "Ayurvedic_Medicine"
  - "Therapeutic_use_of_Formula_-_Inability_to_speak_properly"
date: 2022-04-14
---
# Brāhmī Ghṛta
...
**Brāhmī Ghṛta** is a semisolid preparation made with the ingredients in the Formulation composition given below with Ghrta as the basic ingredient
...
* Brāhmī [svarasa](svarasa.md).
* Treat Ghrta to prepare [Mūrchita Ghrta](Mūrchita_Ghrta.md).
* Take the other ingredients ([Kalka](../Kalka.md) dravya) numbered 3 to 12, wash, dry, powder and pass through sieve number 85.
* Transfer the powdered ingredients to the wet grinder and grind with sufficient quantity of water to prepare a homogeneous blend.

## Other Ayurvedic herb in which used in this preparation
[Centella asiatica](Centella_asiatica.md)
