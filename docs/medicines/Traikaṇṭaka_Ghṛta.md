---
title: "Traikaṇṭaka Ghṛta"
categories:
  - "Ayurvedic Medicine"
  - "Ayurvedic_Medicine"
  - "Therapeutic_use_of_Formula_-_Metabolic_disorders"
  - "Formulations"
  - "Therapeutic_use_of_Formula_-_Gravels_in_urine"
  - "Therapeutic use of Formula - Dysuria"
  - "Therapeutic use of Formula - Burning micturition"
  - "Therapeutic use of Formula - Gravels in urine"
  - "Therapeutic use of Formula - Urinary disorders"
  - "Therapeutic_use_of_Formula_-_Dysuria"
  - "Therapeutic_use_of_Formula_-_Burning_micturition"
  - "Therapeutic use of Formula - Metabolic disorders"
  - "Therapeutic use of Formula - Urinary calculus"
  - "Therapeutic_use_of_Formula_-_Urinary_disorders"
  - "Therapeutic_use_of_Formula_-_Urinary_calculus"
date: 2018-09-20
---
# Traikaṇṭaka Ghṛta
...
**Traikaṇṭaka Ghṛta** is a medicated preparation made with the ingredients in the Formulation composition given below with Gh¨ta as the basic ingredient.

## Formulation composition
| Traikaṇṭaka (Gokṣura API) | [Tribulus terrestris](Tribulus_terrestris.md) | Fr. | 768 g |
| --- | --- | --- | --- |
| Jala API for decoction | Water |  | 12.29 l |
| reduced to |  |  | 3.07 l |
| Elā (Sūkṣmailā API) | [Eletteria cardamomum](Eletteria_cardamomum.md) | Sd. | 9.14 g |
| Girijatu (Śiĺājatu) | Exd. from rock crevices |  | 9.14 g |
| Śilābheda (Pāṣāṇabheda API) | [Bergenia ligulata](Bergenia_ligulata.md) | Rz. | 9.14 g |
| Yaṣṭī API | [Glycyrrhiza glabra](Glycyrrhiza_glabra.md) | Rt. | 9.14 g |
| Varī (Śatāvarī API) | [Asparagus racemosus](Asparagus_racemosus.md) | Rt. | 9.14 g |
| Darbha API | [Imperata cylindrica](Imperata_cylindrica.md) | Rt. | 9.14 g |
...
* Treat [Ghrta](Ghrta.md) to prepare [Murchita Ghrta](Murchita_Ghrta.md).
* Pulverize Gokshura ([kvatha dravya](kvatha_dravya.md)) to coarse powder and add 16 parts of water, heat and reduce the volume to one fourth. Filter with muslin cloth to obtain Gokshura [kvatha](kvatha.md).
* Treat Śilājatu to prepare Śodhita Śilājatu, and keep aside for addition during snehapāka.
