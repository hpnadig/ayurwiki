...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Obstructed_movement_of_Vata_dosha"
...
**Sūṛaṇāvaleha** is a semisolid avaleha preparation made with the ingredients in the Formulation composition given below:

## Formulation composition
| Sūṛaṇa API | [Amorphophallus campanulatus](../herbs/Amorphophallus_campanulatus.md) | Fresh corm | 4.800 kg |
| --- | --- | --- | --- |
...
| Elā (Śūkṣmailā API) | [Elettaria cardamomum](Elettaria_cardamomum.md) | Sd. | 24 g |
...
* Wash, dry, powder ingredients numbered 5 to 12 ([Praksepa dravya](Praksepa_dravya.md)) separately and pass through sieve number 85.
* Remove the skin of Sūraṇa, wash and cut into pieces. Add water in a quantity sufficient to boil the Sūraṇa which could be mashed easily to make a paste maintaining temperature between 900 to 1000 for boiling. Strain the liquid through the muslin cloth.
