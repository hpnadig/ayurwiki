---
title: "Daṣamūla Ghṛta"
categories:
  - "Therapeutic use of Formula - Burning sensation in palms & soles"
  - "Therapeutic_use_of_Formula_-_Cough_due_to_Kapha_dosha"
  - "Therapeutic use of Formula - Puerperal disorders"
  - "Therapeutic_use_of_Formula_-_Diseases_due_to_Vata_Kapha_dosha"
  - "Therapeutic_use_of_Formula_-_Puerperal_disorders"
  - "Ayurvedic Medicine"
  - "Formulations"
  - "Therapeutic use of Formula - Diseases due to Vata Kapha dosha"
  - "Therapeutic use of Formula - Cough due to Kapha dosha"
  - "Therapeutic_use_of_Formula_-_Burning_sensation_in_palms_&_soles"
  - "Therapeutic use of Formula - Cough due to Vata dosha"
  - "Therapeutic_use_of_Formula_-_Cough_due_to_Vata_dosha"
  - "Ayurvedic_Medicine"
date: 2018-09-14
---
# Daṣamūla Ghṛta
...
| Bilva API | [Aegle marmelos](Aegle_marmelos.md) | St.Bk. | 307.6 g |
| --- | --- | --- | --- |
| Śyonāka API | [Oroxylum indicum](Oroxylum_indicum.md). | St.Bk. | 307.6 g |
| Gambhārī API | [Gmelina arborea](Gmelina_arborea.md) | St.Bk. | 307.6 g |
...
| Puṣkarāhvā (Puṣkara API) | [Inula racemosa](Inula_racemosa.md) | Rt. | 12 g |
...
* Pulverize ingredients numbered 1 to 10 ([Kvātha dravya](Kvātha_dravya.md)), to coarse powder, add 4 parts of water, keep for four hours, heat and reduce the volume to one-fourth. Filter with muslin cloth to obtain Dashamoola kvātha.
