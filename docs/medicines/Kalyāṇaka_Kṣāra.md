...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Distention_of_abdomen"
  - "Therapeutic_use_of_Formula_-_Pain_due_to_splenic_disease"
  ...
  - "Therapeutic use of Formula - Distention of abdomen"
  - "Therapeutic_use_of_Formula_-_Piles"
  - "Therapeutic use of Formula - Pain due to splenic disease"
  ...
  - "Therapeutic use of Formula - Flatulence"
  ...
  - "Therapeutic_use_of_Formula_-_Flatulence"
  - "Therapeutic use of Formula - Helminthiasis"
  - "Therapeutic_use_of_Formula_-_Urinary_obstruction"
  - "Ayurvedic_Medicine"
date: 2018-09-20
---
# Kalyāṇaka Kṣāra
...
| Bibhītakī API | [Terminalia bellirica](Terminalia_bellirica.md) | P. | 1 part |
| Āmalakī API | [Phyllanthus emblica](Phyllanthus_emblica.md) (Emblica officinalis) | P. | 1 part |
| Dantī API | [Baliospermum montanum](Baliospermum_montanum.md) | Rt. | 1 part |
| Aruṣkara (Bhallātaka API) | [Semecarpus anacardium](Semecarpus_anacardium.md) | Fr. | 1 part |
...
* Crush [Bhallātaka](Bhallātaka.md) in a khalva to a fine state.
...
1. THE AYURVEDIC PHARMACOPOEIA OF INDIA, PART-II, VOLUME-1, page no 106.
