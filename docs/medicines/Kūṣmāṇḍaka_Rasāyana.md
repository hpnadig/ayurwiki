...
categories:
  ...
  - "Therapeutic use of Formula - Chronic fever"
  ...
  - "Therapeutic_use_of_Formula_-_Chest_wound"
  ...
  - "Therapeutic_use_of_Formula_-_Chronic_fever"
...
| Kūṣmāṇḍaka API | [Benincasa hispida](Benincasa_hispida.md) | Fresh Fr. | 4.8 kg |
| --- | --- | --- | --- |
...
| Śṛṅgavera (Śunhī API) | [Zingiber officinale](../herbs/Zingiber_officinale_-_Ginger,_Alla,_Adrak,_Ingee,_Allam,_Inchi,_Alha.md) | Rz. | 96 g |
...
| Elā (Sūksmailā API) | [Elettaria cardamomum](Elettaria_cardamomum.md) | Sd. | 24 g |
| Patra (Tejaptra API) | [Cinnamomum tamala](Cinnamomum_tamala.md) | Lf. | 24 g |
| Marica API. | [Piper nigrum](Piper_nigrum.md) | Fr. | 24 g |
| Dhānya (Dhānyaka API) | [Coriandrum sativum](Coriandrum_sativum.md) | Fr. | 24 g |
| Kṣaudra (Madhu API) | Honey |  | 384 g |
| Jala API Water Q.S. |  |  |  |

## Method of preparation
* Take all ingredients of pharmacopoeial quality.
* Wash, dry, powder the ingredients number 4 to 11 ([Prakṣepa](../Prakṣepa.md)) separately and pass through sieve number 85.
...
* Add fine powders of ingredients ([praksepa](praksepa.md)) numbered 4 to 11. Mix thoroughly to prepare a homogeneous blend, allow to cool it to room temperature and add Madhu.
