...
categories:
  ...
  - "Ayurvedic Medicine"
  - "Ayurvedic_Medicine"
  - "Therapeutic use of Formula - Loss of strength/immunity"
  - "Therapeutic_use_of_Formula_-_Emaciation"
  - "Formulations"
  - "Therapeutic_use_of_Formula_-_Loss_of_strength/immunity"
  - "Therapeutic use of Formula - Digestive impairment"
  - "Therapeutic use of Formula - Emaciation"
  - "Therapeutic use of Formula - Life prolonging"
  - "Therapeutic_use_of_Formula_-_Life_prolonging"
  - "Therapeutic use of Formula - All children diseases"
  - "Therapeutic_use_of_Formula_-_All_children_diseases"
date: 2018-09-21
---
# Aravindāsava
...
| Nīlotpala (Utpala API) | [Nymphaea stellata](../herbs/Nymphaea_stellata.md) | Fl. | 16 g |
| Mañjiṣṭhā API | [Rubia cordifolia](Rubia_cordifolia.md) | Rt. | 16 g |
| Balā API | [Sida cordifolia](Sida_cordifolia.md) | Rt. | 16 g |
| Māṁsī (Jaṭāmāṁsī API) | [Nardostachys jatamansi](Nardostachys_jatamansi.md) | Rz. | 16g |
| Elā (Sūkṣmailā API) | [Elettaria cardamomum](Elettaria_cardamomum.md) | Sd. | 16 g |
| Ambuda (Mustā API) | [Cyperus rotundus](Cyperus_rotundus.md) | Rz. | 16 g |
| Sārivā (Śveta Sārivā API) | [Hemidesmus indicus](Hemidesmus_indicus.md) | Rt. | 16 g |
| Śivā (Harītakī API) | [Terminalia chebula](Terminalia_chebula.md) | P. | 16 g |
| Bibhītaka API | [Terminalia bellirica](Terminalia_bellirica.md) | P. | 16 g |
| Vacā API | [Acorus calamus](Acorus_calamus.md) | Rz. | 16 g |
| Dhātrī (Āmalakī API) | [Emblica officinalis](Emblica_officinalis.md) | P. | 16 g |
...
| Murā API | [Selinium tenuifolium](Selinium_tenuifolium.md) | Rt. | 16 g |
| Drākṣā API | [Vitis vinifera](Vitis_vinifera.md) | Dry Fr. | 320 g |
| Dhtākī API | [Woodfordia fruticosa](Woodfordia_fruticosa.md) | Fl. | 256 g |
| Jala Water |  |  | 8.19 l |
| Śarkarā API | Sugar |  | 1.6 kg |
| Mākṣika (Madhu API) | Honey |  | 0.8 kg |
...
* Add specified amount of water to the ingredient number 27 of the formulation composition, allow to dissolve and filter through the muslin cloth.
...
| Total phenolic content | Not less than 0.05 per cent |
| --- | --- |
| Total solids | 10 to 20 per cent |
| Specific gravity (at 25º) | 1.0 to 1.1 |
| pH | 3.0 to 4.5 |
| Reducing sugars | 3.5 to 5.5 per cent |
