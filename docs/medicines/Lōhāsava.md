...
categories:
  ...
  - "Therapeutic_use_of_Formula_-_Disease_of_heart"
  ...
  - "Ayurvedic_Medicine"
  - "Therapeutic_use_of_Formula_-_Weak_digestion"
date: 2023-07-14
---
# Lōhāsava
...
| Bibhītaka API | [Terminalia bellierica](Terminalia_bellierica.md) | P. | 192 g |
| Āmalakī API | [Emblica officinalis](Emblica_officinalis.md) | P. | 192 g |
| Yavānikā (Yavānī API) | [Trachyspermum ammi](Trachyspermum_ammi.md) | Fr. | 192 g |
| Viḍaṅga API | [Embelia ribes](Embelia_ribes.md) | Fr. | 192 g |
| Mustaka (Mustā) API) | [Cyperus rotundus](Cyperus_rotundus.md) | Rz. | 192 g |
| Citra (Eraṇḍa) API) | [Ricinus communis](Ricinus_communis.md) | Rt. | 192 g |
...
## Therapeutic uses
* Jaṭhara (Weak digestion), Pāṇḍu (Anaemia), Śvayathu (Oedema), Gulma (Abdominal lump), Arśa (Piles), Agnimāndya (Digestive impairment), Plīhā Roga (Splenic disease), Kuṣṭa (Disease of skin), Kāsa (Cough), Śvāsa (Asthma), Bhagandara (Fistula-in-ano), Aruci (Tastelessness), Grahaṇī (Malabsorption syndrome), Hṛdroga (Disease of heart).
