---
title: "Koṭṭamcukkādi Taila"
categories:
  - "Ayurvedic Medicine"
  - "Therapeutic use of Formula - Rheumatism"
  - "Formulations"
  - "Therapeutic use of Formula - Disorders due to vata dosha"
  - "Therapeutic_use_of_Formula_-_Rheumatism"
  - "Therapeutic_use_of_Formula_-_Stiffness_of_body"
  - "Therapeutic_use_of_Formula_-_Disorders_due_to_vata_dosha"
  - "Ayurvedic_Medicine"
  - "Therapeutic use of Formula - Stiffness of body"
date: 2018-09-20
---
# Koṭṭamcukkādi Taila
...
| Kārtoṭṭi (Hiṁsrā API) | [Capparis spinosa](Capparis_spinosa.md) | Rt. | 21 g |
| Devadruma (Devadāru API) | [Cedrus deodara](Cedrus_deodara.md) | Ht.Wd | 21 g |
| Siddhārtha (Sarṣapa API) | [Brassica campestris](../herbs/Brassica_campestris.md) | Sd. | 21 g |
| Suvahā (Rāsnā API) | [Alpinia galanga](Alpinia_galanga.md) (Official substitute) | Rz. | 21 g |
| Tilaja (Tila API) | Sesamum indicum | Oil | 768 g |
| [Dadhi](../Dadhi.md) (Godadhi API) | Curd from cow’s milk |  | 768 g |
| Ciñcā rasa (Ciñcā API) | [Tamarindus indica](Tamarindus_indica.md) | Lf. | 3.07 l |
...
* Collect fresh leaves of ingredient number 12, wash thoroughly, grind and express [svarasa](svarasa.md) through muslin cloth.
